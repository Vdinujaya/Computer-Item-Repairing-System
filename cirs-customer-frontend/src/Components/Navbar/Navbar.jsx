  ...
  return (
    <div className='navbar'>
        <div className='nav-logo'>
            <h1><Link to='/' style={{textDecoration:'none',color:'black',background:'gold'}}>FixIT Hub</Link></h1>
        </div>
        <ul className='nav-menu' style={{background:'gold'}}>
            <li><Link to='/services' style={{textDecoration:'none',color:'black',background:'gold',transition:'color 0.5s'}} onMouseEnter={(e) => e.target.style.color = 'white'} onMouseLeave={(e) => e.target.style.color = 'black'}>Services</Link></li>
            ...
            <li><Link to='/aboutus' style={{textDecoration:'none',color:'black',background:'gold',transition:'color 0.5s'}} onMouseEnter={(e) => e.target.style.color = 'white'} onMouseLeave={(e) => e.target.style.color = 'black'}>About Us</Link></li>
